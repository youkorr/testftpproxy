...
public:
    ...
    // Nouvelle méthode pour gérer les requêtes de type Range
    bool download_file_with_range(const std::string &remote_path, httpd_req_t *req, long start, long end);

    // Méthodes pour la gestion des fichiers distants
